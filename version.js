...
const versionData = [
  ...
  "V2: Changed format to RPG type. Use WASD to control your goose and walk around the map. Fixed issue with geese not walking around automatically, and fixed issue where baby geese can lay eggs. Also improved rendering with dedicated render pipline."
];
