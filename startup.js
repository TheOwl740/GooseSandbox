...
const version = 0;
const versionData = [
  "V0: Welcome to Goose Sandbox version 0:  this version is before my engine rework and is the original release. You will get an alert like this on startup every time there is a new version of the game."
];
if(version != localStorage.getItem("version")) {
  ...
  alert(localStorage.getItem("version") !== null ? "There have been " + (version - Number(localStorage.getItem("version"))) + " updates since you last visited Goose Sandbox: " + ret : versionData[0]);
